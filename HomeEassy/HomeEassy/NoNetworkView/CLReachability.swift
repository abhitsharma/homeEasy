...
class CLReachability {
    ...
    typealias ReachabilityHandler = (CLReachability) -> Void
    ...
    fileprivate let reachabilityQueue = DispatchQueue(label: "com.cleo.reachability")
...
func callback(reachability: SCNetworkReachability, flags: SCNetworkReachabilityFlags, info: UnsafeMutableRawPointer?) {
    ...
    let reachability = Unmanaged<CLReachability>.fromOpaque(info).takeUnretainedValue()
...
extension CLReachability {
    ...
    func startNotifier() {
        ...
        context.info = UnsafeMutableRawPointer(Unmanaged<CLReachability>.passUnretained(self).toOpaque())
